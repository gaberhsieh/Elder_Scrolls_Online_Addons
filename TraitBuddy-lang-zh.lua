local strings = {
	SI_BINDING_NAME_TB_TOGGLE_GUI	= "切換 TraitBuddy",
	TB_KNOWN 			= "已被熟知",
	TB_BEING_RESEARCHED 		= "正在被研究",
	TB_COULD_RESEARCH		= "可被研究",
	TB_YOU_KNOW			= "你知曉此特性",
	TB_YOU_ARE_RESEARCHING		= "你正在研究此特性",
	TB_YOU_COULD_RESEARCH		= "你可以研究此特性",
	TB_ESOPLUS_CHAT			= "你的ESO+會員資格已被更動，重新登入你的其他角色已更新研究時間",
	TB_LINK_ACHIEVEMENT		= "連結成就",
	TB_MAIL_KNOWN			= "知曉 %s 特性",
	TB_MAIL_UNKNOWN			= "未知曉 %s 特性",
	TB_MOTIF_ALMOST			= "幾乎完成",
