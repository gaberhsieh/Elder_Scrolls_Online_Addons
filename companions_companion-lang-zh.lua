local chineseStrings = {
    ...
    CC_TEXT_GOOD_RAPPORT       = "發展正面關係", -- Title
    CC_TEXT_BAD_RAPPORT        = "發展負面關係",  -- Title
    CC_REMINDER_BTN            = "提醒",       -- Remind btn text
    CC_CANCEL_BTN              = "取消",       -- Cancel btn text
    CC_ERROR_START_TIMER       = "計時器啟動失敗",
    CC_RESET_MODAL_TITLE       = "計時器重置",
    CC_RESET_MODAL_DESCRIPTION = "確認要為此事件重置計時器?",
    ...
    CC_5_HOURS                           = "5 小時",
    CC_20_HOURS                          = "20 小時",
    CC_24_HOURS                          = "每日 (24 小時)",
    CC_FIRST_TIME                        = "首次",
    CC_OTHER_TIMES                       = "非首次/其它時間",
    ...
    CC_SHARED_COMPLETE_PERSONAL_QUEST  = "完成個人任務",
    CC_SHARED_DARK_BROTHERHOOD         = "進入黃金海岸的黑暗兄弟會聖索",
    CC_SHARED_USE_BLADE_OF_WOE_NPC     = "對任何 NPC 使用 Blade of Woe，包括敵人",
    CC_SHARED_COMPLETE_MAGES_DAILY     = "完成 Alvur Baren 提供的法師公會每日任務",
    CC_SHARED_COMPLETE_ASHLANDER_DAILY = "完成每日 Ashlander hunt 任務",
    CC_SHARED_LOOTING_PSIJIC_PORTAL    = "搜刮一個 Psijic 傳送門",
    CC_SHARED_PICKPOCKET_GUARD         = "對一個守衛扒竊",
    CC_SHARED_MUNDUS_STONE             = "參訪一個 Mundus 之石",
    CC_SHARED_TRESPASS                 = "侵闖禁區",
    CC_SHARED_FLEE_GUARD               = "成功逃離守衛",
    CC_SHARED_MURDER                   = "殘忍殺害一個無辜的 NPC", -- Bastian 1 hour?
    CC_SHARED_HEAVY_SACK               = "搜刮重麻袋",

    --[[
        Bastian
    ]]
    -- Good
    CC_GOOD_BASTIAN_TEXT_2 = "進入位於聯盟區域內的法師公會大廳",
    CC_GOOD_BASTIAN_TEXT_3 = "參訪 Eyevea 或 Artaeum",
    CC_GOOD_BASTIAN_TEXT_4 = "完成一次隨機事件，幫助他人（例如：從強盜手中解救商人，從魔族手中解救召喚師，以及在伏擊中解救旅行者）",
    CC_GOOD_BASTIAN_TEXT_6 = "占卜一件古物",
    CC_GOOD_BASTIAN_TEXT_7 = "參訪一個 crafting station", -- Needs to be veryfied (no mention on UESP)
    CC_GOOD_BASTIAN_TEXT_8 = "讀一本書",
    CC_GOOD_BASTIAN_TEXT_9 = "在暗錨起始時，殺死一個黑蟲教邪教徒",
    CC_GOOD_BASTIAN_TEXT_10 = "殺死一個強盜",
    CC_GOOD_BASTIAN_TEXT_12 = "殺死任何邪教徒",

    -- Bad
    CC_BAD_BASTIAN_TEXT_1 = "在偷竊或扒竊時被發現",
    CC_BAD_BASTIAN_TEXT_3 = "扒竊",
    CC_BAD_BASTIAN_TEXT_5 = "殺死家畜（例如：雞、蛙等等）",
    CC_BAD_BASTIAN_TEXT_6 = "偷竊",
    CC_BAD_BASTIAN_TEXT_7 = "被守衛盤問時，選擇逃跑",
    CC_BAD_BASTIAN_TEXT_8 = "烹煮起司料理",
    CC_BAD_BASTIAN_TEXT_9 = "攻擊無辜的 NPC",
    ...
    CC_GOOD_ZERITH_TEXT_14                    = "參訪 Baandari 交易站",
...
for index, value in pairs(chineseStrings) do
